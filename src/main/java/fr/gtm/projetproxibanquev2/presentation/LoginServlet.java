...
/**
 * Servlet permettant la connexion d'un conseiller ou d'un g�rant
 * 
 * @author S�verin
 *
 */
...
public class LoginServlet extends HttpServlet {
	...
	/**
	 * Methode traitement qui va traiter les requetes HTTP et notamment r�cup�rer le login et mot de passe d'une page JSP pour le rediriger
	 * @param request
	 * @param response
	...
	protected void traitement(HttpServletRequest request, HttpServletResponse response)
		...
		// si login/password correspond a rien, dispatcher reste à connexionRefusee.jsp
